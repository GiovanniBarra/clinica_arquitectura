...
def addColaboradores(request):
    api_url = 'https://centromedicogiovanni--giovannibarra31.repl.co/api/usuarios/add'
...
def login(request):
    api_url = 'https://centromedicogiovanni--giovannibarra31.repl.co/api/usuarios/login'
...
def listado(request):
    try:
        api_url = 'https://centromedicogiovanni--giovannibarra31.repl.co/api/usuarios'
        ...
        if tipo_usuario:
            ...
            response = requests.post('https://centromedicogiovanni--giovannibarra31.repl.co/api/usuarios/tipo', data=data_json, headers=headers)
            if response.status_code == 200:
                usuarios = response.json()
                if "message" in usuarios:
        ...
        if id_especialidad:
            ...
            response = requests.post('https://centromedicogiovanni--giovannibarra31.repl.co/api/usuarios/especialidad', data=data_json, headers=headers)
            if response.status_code == 200:
                usuarios = response.json()
                if "message" in usuarios:
        ...
        if rut:
            ...
            response = requests.post('https://centromedicogiovanni--giovannibarra31.repl.co/api/usuarios/buscarUsuario', data=data_json, headers=headers)
            if response.status_code == 200:
...
def modificarusuario(request,id):
    ...
    api_url = 'https://centromedicogiovanni--giovannibarra31.repl.co/api/usuarios/buscarUsuario'
    ...
    if request.method == 'POST':
        ...
        try:
            url = 'https://centromedicogiovanni--giovannibarra31.repl.co/api/usuarios/mod'
            # Realizar una solicitud POST a la API de Flask para crear un usuario
...
def eliminar(request,id,estado):
    if request.method == 'POST':
        ...
        try:
            url = 'https://centromedicogiovanni--giovannibarra31.repl.co/api/usuarios/act'
...
def tomaFecha(request):
    api_url = 'https://centromedicogiovanni--giovannibarra31.repl.co/api/horario-medico/fecha'
...
def registrohorario(request,id):
    api_url = 'https://centromedicogiovanni--giovannibarra31.repl.co/api/horario-medico/add'
...
def listadoHorarioMedico(request, id):
    try:
        api_url = "https://centromedicogiovanni--giovannibarra31.repl.co/api/horario-medico/buscar"
...
def confirmaciontoma(request,data):
    api_url = "https://centromedicogiovanni--giovannibarra31.repl.co/api/atenciones/add"
...
def buscarAtencion(request):
    ...
    try:
        api_url = "https://centromedicogiovanni--giovannibarra31.repl.co/api/atenciones/buscar"
